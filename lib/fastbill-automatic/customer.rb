  ...
  module Automatic
    class Customer < Base
      ...
      attr_accessor :customer_number, :country_code, :city, :term, :comment, :paymill_token,
                    ...
                    :newsletter_optin, :language_code, :affiliate, :invoice_delivery_method, :x_attributes,
      ...
      attr_reader :customer_id, :dashboard_url, :changedata_url, :status, :created, :last_update, :credit_balance, :hash,
                  :accountdata_url
    end
  end
end